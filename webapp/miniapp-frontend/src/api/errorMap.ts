...
const MAP: Record<string, MappedError> = {
  ...
  kick_forbidden_state: {
    ...
    message: "Удалять игроков можно только в лобби.",
    cta: "Перейдите в лобби и повторите действие."
  },
  kick_admin_forbidden: {
    title: "Админа нельзя удалить",
    message: "Администратор остается в составе лобби, пока активна эта игра.",
    cta: "Выберите другого игрока."
  },
  kick_target_not_found: {
    title: "Игрок уже вышел",
    message: "Этот игрок больше не состоит в лобби.",
    cta: "Обновите экран и попробуйте снова."
  },
  private_mode_only: {
